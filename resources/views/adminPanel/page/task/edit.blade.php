...
<div class="container mt-5">
    <div class="row p-2 align-items-center">
        ...
        <h1 class="h1 mr-auto ml-auto">Edit Task</h1>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="pt-5" method="POST" action="{{ route('admin.task.update',['task'=>$task]) }}"
                    ...
                    <div class="form-group row justify-content-center">
                        <div class="col-md-8">
                            <textarea id="article" placeholder="Article" name="article"
                                ...
                                rows="5" required>{{old('article')}}{{$task->article}}</textarea>
                            @error('article')
                            <span class="invalid-feedback px-2 " role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
