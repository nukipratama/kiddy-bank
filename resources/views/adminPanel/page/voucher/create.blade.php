...
<div class="container mt-5">
    <div class="row p-2 align-items-center">
        ...
        <h1 class="h1 mr-auto ml-auto">Add Voucher</h1>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="pt-5" method="POST" action="{{ route('admin.voucher.store') }}"
                    ...
                    <div class="form-group row justify-content-center">
                        <div class="col-md-8">
                            <input id="code" type="text"
                                ...
                                name="code" value="{{ old('code') }}" required autofocus placeholder="Voucher Code">
